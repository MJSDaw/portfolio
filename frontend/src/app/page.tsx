        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 md:grid-cols-3">
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-800 shadow rounded-lg px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5 flex items-center space-x-2 sm:space-x-3 md:space-x-4 transition-transform hover:scale-105">
                <div className="text-2xl sm:text-3xl">{skill.icon}</div>
                <div className="text-sm sm:text-base md:text-lg font-medium text-gray-900 dark:text-white truncate">{skill.name}</div>
              </div>
            ))}
          </div>
        </div>
