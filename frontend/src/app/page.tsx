        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
            ...
            <div className="md:col-span-3 space-y-6">
              ...
              <p className="text-lg text-gray-500 dark:text-gray-300">
                Con más de X años de experiencia en el desarrollo web, he trabajado en una variedad de proyectos que van desde sitios web corporativos hasta aplicaciones web complejas.
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 md:grid-cols-3">
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-800 shadow rounded-lg px-6 py-5 flex items-center space-x-4 transition-transform hover:scale-105">
